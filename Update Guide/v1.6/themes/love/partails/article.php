...
<div class="col l4 m6">
	<div class="dt_sections articles qd_blog_lists">
		...
		<div class="qd_blog_list_info">
			...
			<a class="btn btn_primary btn-blog" href="<?php echo $site_url;?>/article/<?php echo $article->id . '_' . url_slug(html_entity_decode($article->title),array('delimiter' => '-'));?>" data-ajax="/article/<?php echo $article->id . '_' . url_slug(html_entity_decode($article->title),array('delimiter' => '-'));?>"><?php echo __( 'READ MORE' );?> </a>
		</div>
	</div>
</div>
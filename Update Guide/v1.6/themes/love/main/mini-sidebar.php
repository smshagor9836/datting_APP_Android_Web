<div class="dt_mini_sidebar_links">
	<ul class="home_usr_link">
		<li class="vis <?php if($data['name'] == 'profile'){ echo 'active';}?>">
			<a href="<?php echo $site_url;?>/@<?php echo $profile->username;?>" data-ajax="/@<?php echo $profile->username;?>"><img src="<?php echo $profile->avater->avater;?>" alt="<?php echo $profile->full_name;?>" /> <span><?php echo __( 'Profile' );?></span></a>
		</li>
		...
		<?php if (!empty($config->native_android_url) || !empty($config->native_ios_url)) { ?>
	        <ul class="list-group" id="sidebar-group-list-container">
	            <li class="list-group-item text-muted sidebar-title-back" contenteditable="false"><?php echo __( 'apps' );?>
	            </li>
	            <li class="list-group-item wo_side_apps">
	            	<?php if (!empty($config->native_android_url) || !empty($config->native_ios_url)) { ?>
						<p><?php echo __( 'get_mobile_apps' );?></p>

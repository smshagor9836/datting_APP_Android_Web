...
function userProfile($username, $cols = array(),$only_token = false){
    ...
    if ($db->count > 0) {
        ...
        if (!empty($user) && !empty($user->is_pro) && $user->is_pro == 1) {
            if ($user->pro_type == 1) {
                $icon = '<svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 0 576 512"><!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M381.2 150.3L524.9 171.5C536.8 173.2 546.8 181.6 550.6 193.1C554.4 204.7 551.3 217.3 542.7 225.9L438.5 328.1L463.1 474.7C465.1 486.7 460.2 498.9 450.2 506C440.3 513.1 427.2 514 416.5 508.3L288.1 439.8L159.8 508.3C149 514 135.9 513.1 126 506C116.1 498.9 111.1 486.7 113.2 474.7L137.8 328.1L33.58 225.9C24.97 217.3 21.91 204.7 25.69 193.1C29.46 181.6 39.43 173.2 51.42 171.5L195 150.3L259.4 17.97C264.7 6.954 275.9-.0391 288.1-.0391C300.4-.0391 311.6 6.954 316.9 17.97L381.2 150.3z"/></svg>';
            }
            elseif ($user->pro_type == 2) {
                $icon = '<svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M323.5 51.25C302.8 70.5 284 90.75 267.4 111.1C240.1 73.62 206.2 35.5 168 0C69.75 91.12 0 210 0 281.6C0 408.9 100.2 512 224 512s224-103.1 224-230.4C448 228.4 396 118.5 323.5 51.25zM304.1 391.9C282.4 407 255.8 416 226.9 416c-72.13 0-130.9-47.73-130.9-125.2c0-38.63 24.24-72.64 72.74-130.8c7 8 98.88 125.4 98.88 125.4l58.63-66.88c4.125 6.75 7.867 13.52 11.24 19.9C364.9 290.6 353.4 357.4 304.1 391.9z"/></svg>';
            }
            elseif ($user->pro_type == 3) {
                $icon = '<svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 0 384 512"><!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M240.5 224H352C365.3 224 377.3 232.3 381.1 244.7C386.6 257.2 383.1 271.3 373.1 280.1L117.1 504.1C105.8 513.9 89.27 514.7 77.19 505.9C65.1 497.1 60.7 481.1 66.59 467.4L143.5 288H31.1C18.67 288 6.733 279.7 2.044 267.3C-2.645 254.8 .8944 240.7 10.93 231.9L266.9 7.918C278.2-1.92 294.7-2.669 306.8 6.114C318.9 14.9 323.3 30.87 317.4 44.61L240.5 224z"/></svg>';
            }
            elseif ($user->pro_type == 4) {
                $icon = '<svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M156.6 384.9L125.7 353.1C117.2 345.5 114.2 333.1 117.1 321.8C120.1 312.9 124.1 301.3 129.8 288H24C15.38 288 7.414 283.4 3.146 275.9C-1.123 268.4-1.042 259.2 3.357 251.8L55.83 163.3C68.79 141.4 92.33 127.1 117.8 127.1H200C202.4 124 204.8 120.3 207.2 116.7C289.1-4.07 411.1-8.142 483.9 5.275C495.6 7.414 504.6 16.43 506.7 28.06C520.1 100.9 516.1 222.9 395.3 304.8C391.8 307.2 387.1 309.6 384 311.1V394.2C384 419.7 370.6 443.2 348.7 456.2L260.2 508.6C252.8 513 243.6 513.1 236.1 508.9C228.6 504.6 224 496.6 224 488V380.8C209.9 385.6 197.6 389.7 188.3 392.7C177.1 396.3 164.9 393.2 156.6 384.9V384.9zM384 167.1C406.1 167.1 424 150.1 424 127.1C424 105.9 406.1 87.1 384 87.1C361.9 87.1 344 105.9 344 127.1C344 150.1 361.9 167.1 384 167.1z"/></svg>';
            }
...
function UploadToS3($filename, $options = array()) {
    ...
    if ($config->amazone_s3 == 0 && $config->spaces == 0 && $config->wasabi_storage == 0 && $config->ftp_upload == 0 && $config->cloud_upload == 0) {
        return false;
    }
    if ($config->amazone_s3 == 1) {
        if (empty($config->amazone_s3_key) || empty($config->amazone_s3_s_key) || empty($config->region) || empty($config->bucket_name)) {
        ...
        require_once("lib/s3/vendor/autoload.php");
    ...
    elseif ($config->ftp_upload == 1) {
        include_once('lib/ftp/vendor/autoload.php');
    ...
    elseif ($config->cloud_upload == 1) {
        require_once 'lib/cloud/vendor/autoload.php';
        try {
...
function SendEmail($to, $subject, $message, $db = false) {
    ...
    require_once($_LIBS . "PHPMailer-Master/vendor/autoload.php");
    $mail = new PHPMailer;
    if (empty($to)) {
        return false;
    }
...
function ShareFile($data = array(), $type = 0, $crop = true,$fldr=false) {
    ...
    if (move_uploaded_file($data['file'], $filename)) {
                ...
                if ($type == 1) {
                    ...
                    if (Resize_Crop_Image(400, 400, $filename, $last_file, 60)) {
                        if (empty($data['local_upload'])) {
                            if (($config->amazone_s3 == 1 || $config->spaces == 1 || $config->wasabi_storage == 1 || $config->ftp_upload == 1 || $config->cloud_upload == 1) && !empty($last_file)) {
        ...
        if (empty($data['local_upload'])) {
            if (($config->amazone_s3 == 1 || $config->spaces == 1 || $config->wasabi_storage == 1 || $config->ftp_upload == 1 || $config->cloud_upload == 1) && !empty($filename)) {
...
function watermark_image($target) {
    global $config, $db,$conn,$site_url;
    require_once("lib/SimpleImage-master/vendor/autoload.php");

    ...
    <div class="dt_settings">
		<div class="row">
			<div class="col s12 m4">
				<div class="dt_settings_bg_wrap">
					<ul class="dt_settings_side_links">
						...
						<?php }?>
						<li>
							<a class="active" href="<?php echo $site_url;?>/settings-blocked/<?php echo $profile->username;?>" data-ajax="/settings-blocked/<?php echo $profile->username;?>" target="_self">
			...
			<div class="col s12 m8">
				<form method="post" action="" class="dt_settings_bg_wrap">
					<h2 class="dt_sett_wrap_title"><?php echo __( 'Blocked Users' );?></h2>

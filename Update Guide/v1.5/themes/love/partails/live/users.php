<?php global $site_url;?>
<div class="col l3 m4 s6 xs12" data-liked-uid="<?php echo $value->id?>">
    <div class="dt_live_users center" onclick="RunLiveAgora('<?php echo $value->stream_name?>','post_live_video','<?php echo $value->agora_token?>',<?php echo $value->id?>)">
        ...
        <?php } ?>
		<p class="time ajax-time age" title="<?php echo $value->user_data->created_at;?>"><?php echo get_time_ago( strtotime($value->user_data->created_at) );?></p>

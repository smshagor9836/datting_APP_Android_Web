    ...
    <div class="dt_settings row">
		<div class="row">
				...
				<div class="dt_settings_bg_wrap">
					<ul class="dt_settings_side_links">
						...
						<?php if( $config->two_factor == '1' ){ ?>
							<li>
								<a class="active" href="<?php echo $site_url;?>/settings-twofactor/<?php echo $profile->username;?>" data-ajax="/settings-twofactor/<?php echo $profile->username;?>" target="_self">
			...
			<div class="col s12 m8">
				<form method="post" action="/profile/save_twofactor_setting" class="dt_settings_bg_wrap" id="twofactor_settings">
					<h2 class="dt_sett_wrap_title"><?php echo __( 'Two-factor authentication' );?></h2>

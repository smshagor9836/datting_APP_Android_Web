    ...
    <div class="dt_settings">
		<div class="row">
				...
				<div class="dt_settings_bg_wrap">
					<ul class="dt_settings_side_links">
						...
						<?php if( $config->social_media_links == 'on' ){ ?>
							<li>
								<a class="active" href="<?php echo $site_url;?>/settings-social/<?php echo $profile->username;?>" data-ajax="/settings-social/<?php echo $profile->username;?>" target="_self">
			...
			<div class="col s12 m8">
				<form method="post" action="/profile/save_social_setting" class="dt_settings_bg_wrap">
					<h2 class="dt_sett_wrap_title"><?php echo __( 'Social Links' );?></h2>

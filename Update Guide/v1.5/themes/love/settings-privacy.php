    ...
    <div class="dt_settings">
		<div class="row">
			<div class="col s12 m4">
				<div class="dt_settings_bg_wrap">
					<ul class="dt_settings_side_links">
						...
						<li>
							<a class="active" href="<?php echo $site_url;?>/settings-privacy/<?php echo $profile->username;?>" data-ajax="/settings-privacy/<?php echo $profile->username;?>" target="_self">
			...
			<div class="col s12 m8">
				<form method="post" action="/profile/save_privacy_setting" class="dt_settings_bg_wrap">
					<h2 class="dt_sett_wrap_title"><?php echo __( 'Privacy' );?></h2>

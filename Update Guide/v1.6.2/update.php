...
if (!empty($_POST['update_langs'])) {
    ...
    unset($data[2]);
    unset($data[3]);
    $sql = mysqli_query($conn, "ALTER TABLE `langs` DROP INDEX `langs_english_index`;");
    foreach ($data as $key => $lang) {
      $queryLang = "ALTER TABLE `langs` CHANGE `{$lang}` `{$lang}` LONGTEXT CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL";
      $sql = mysqli_query($conn, $queryLang);
    }
            ...
            <div class="col-md-10">
               <div class="wo_install_wiz">
                 <?php if ($updated == false) { ?>
                  <div>
                     <h2 class="light">Update to v1.6.2 </span></h2>
                     <div class="setting-well">
                        <h4>Changelog</h4>
                        <ul class="wo_update_changelog">
                          <li>[Fixed] character limit for terms page.</li>
                          <li>[Fixed] "index" showing on home page. </li>
                          <li>[Fixed] 500 PHP error when uploading stickers. </li>
                        </ul>
...
<script>
var queries = [
    "UPDATE `options` SET `option_value`= '1.6.2' WHERE option_name = 'version';",

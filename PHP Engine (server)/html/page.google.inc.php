        ...
        if (!isset($token['error']))
        {
            ...
            if (auth::getCurrentUserId() != 0) {
                ...
                if ($account_id != 0) {
                    ...
                    $_SESSION['oauth_id'] = $data['id'];
                    $_SESSION['oauth_name'] = "Google User";

                    if (!empty($data['given_name']))
                    {

                        $_SESSION['oauth_name'] = $data['given_name'];
                    }

                    if (!empty($data['family_name']))
                    {

                        $_SESSION['oauth_name'] = $_SESSION['oauth_name']." ".$data['family_name'];
                    }
                    ...
                    if (!empty($data['email']))
                    {
                        ...
                        $_SESSION['oauth_email'] = $data['email'];
                    }

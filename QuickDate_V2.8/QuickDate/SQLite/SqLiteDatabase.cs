            ...
            try
            {
                ...
                if (settingsData != null)
                {
                    ...
                    if (select == null)
                    {
                        ...
                        db.CashfreeCurrencyArray = JsonConvert.SerializeObject(settingsData.CashfreeCurrencyArray);
                        db.IyzipayCurrencyArray = JsonConvert.SerializeObject(settingsData.IyzipayCurrencyArray);

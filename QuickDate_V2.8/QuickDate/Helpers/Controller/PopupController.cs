...
{
    public class PopupController: Object 
    {
        ...
        private void BtnAddPhoneNumberOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var dialog = new MaterialDialog.Builder(ActivityContext).Theme(QuickDateTools.IsTabDark() ? MaterialDialogsTheme.Dark : MaterialDialogsTheme.Light);
                    ...
                    case PaymentsSystem.All:
                        {
                            ...
                            bottomSheetDialog.Show(GlobalContext.SupportFragmentManager, bottomSheetDialog.Tag);
                            break;
                        }
                    ...
                    if (item != null)
                    {
                        ...
                        switch (AppSettings.PaymentsSystem)
                        {
                            ...
                            case PaymentsSystem.JustInAppBillingGoogle when AppSettings.ShowInAppBilling && InitializeQuickDate.IsExtended:
                            {
                                ...
                                //if (GlobalContext.ItemCredits.TotalCoins == option?.BagOfCreditsAmount)
                                //{
                                //    GlobalContext.PayType = "bagofcredits";
                                //}
                                //else if (GlobalContext.ItemCredits.TotalCoins == option?.BoxOfCreditsAmount)
                                //{
                                //    GlobalContext.PayType = "boxofcredits";
                                //}
                                //else if (GlobalContext.ItemCredits.TotalCoins == option?.ChestOfCreditsAmount)
                                //{
                                //    GlobalContext.PayType = "chestofcredits";
                                //}

                                //if (!string.IsNullOrEmpty(GlobalContext.PayType))
                                //    GlobalContext?.BillingSupport?.PurchaseNow(GlobalContext.PayType);
                            }
                                break;
                        }

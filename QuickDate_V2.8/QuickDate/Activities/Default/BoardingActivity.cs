    ...
    public class BoardingActivity : AhoyOnboarderActivity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            try
            {
                ...
                onBoarderCard1.TitleColor = Resource.Color.gnt_white;
                onBoarderCard2.TitleColor = Resource.Color.gnt_white;
                onBoarderCard3.TitleColor = Resource.Color.gnt_white;

                onBoarderCard1.DescriptionColor = Resource.Color.gnt_white;
                onBoarderCard2.DescriptionColor = Resource.Color.gnt_white;
                onBoarderCard3.DescriptionColor = Resource.Color.gnt_white;

    ...
    public class UsersFilterBottomDialogFragment : BottomSheetDialogFragment 
    {
        ...
        private void InitComponent(View view)
        {
            try
            {
                ...
                ButtonGirls.SetBackgroundResource(Resource.Drawable.follow_button_profile_friends_withoutstock);
                ...
                ButtonMan.SetBackgroundResource(Resource.Drawable.follow_button_profile_friends_withoutstock);
        ...
        private void ButtonGirlsOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                ButtonBoth.SetBackgroundResource(Resource.Drawable.follow_button_profile_friends_withoutstock);

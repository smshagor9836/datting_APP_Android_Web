package app.manager.dating.model;
...
public class Profile extends Application implements Constants, Parcelable {
    ...
    private int feeling, sex_orientation = 0, age = 0, height, weight, state, sex = 3, year, month, day, verify, verified, pro, itemsCount, likesCount, giftsCount, friendsCount, followingsCount, followersCount, photosCount, matchesCount, allowPhotosComments, allowShowMyBirthday, allowMessages, lastAuthorize;
    ...
    private int photoPostModerateAt = 0, coverPostModerateAt = 0;
    ...
    public Profile(JSONObject jsonData) {
        ...
        try {
            ...
            if (!jsonData.getBoolean("error")) {
                ...
                this.setVerified(jsonData.getInt("verify"));
                ...
                if (jsonData.has("photoPostModerateAt")) {

                    this.setPhotoPostModerateAt(jsonData.getInt("photoPostModerateAt"));
                }

                if (jsonData.has("coverPostModerateAt")) {

                    this.setCoverPostModerateAt(jsonData.getInt("coverPostModerateAt"));
                }
            }
    ...
    public void setVerify(int verified) {
    ...
    public void setVerified(int profileVerified) {

        this.verified = profileVerified;
    }
    ...
    public void setPhotoPostModerateAt(int photoPostModerateAt) {

        this.photoPostModerateAt = photoPostModerateAt;
    }

    public long getPhotoPostModerateAt() {

        return this.photoPostModerateAt;
    }

    public void setCoverPostModerateAt(int coverPostModerateAt) {

        this.coverPostModerateAt = coverPostModerateAt;
    }

    public int getCoverPostModerateAt() {

        return this.coverPostModerateAt;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(this.photoPostModerateAt);
        dest.writeInt(this.coverPostModerateAt);
    }
    ...
    protected Profile(Parcel in) {
        ...
        this.photoPostModerateAt = in.readInt();
        this.coverPostModerateAt = in.readInt();
    }
